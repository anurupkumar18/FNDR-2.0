...
pub use indexed_merge::{CaptureMergeOutcome, ContinuityCandidate, IndexStampReport};
...
pub use store::{
    ...
    ChunkSearchHit, DeleteScope, LedgerDecision, NewChunk, NewRecord, PendingChunk, RecordEvidence,
    ResultFeedback, SEARCH_LIMIT_CAP, SearchExplanation, Store, StoreError, TimelineGranularity,
};
