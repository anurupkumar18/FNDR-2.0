...
//!
//! Ten of the 14 ADR-007 tools are wired: `fndr.search`,
...
pub use server::{
    ...
    FndrMcpServer, OpenTargetOutput, OpenTargetParams, PackedEvidence, PrivacyStatusOutput,
    PrivacyStatusParams, RecallKind, RecallOutput, RecallParams, RecalledDecision,
