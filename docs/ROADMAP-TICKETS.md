...
| T-308 adaptive sampling | Partial 2026-09-06 | `fndr-capture::SamplingPolicy` implements the pure active/idle/deep-idle/forced-capture curve with a simulated timeline test. Missing: the macOS input-idle adapter and worker wiring; no background polling was added. |
