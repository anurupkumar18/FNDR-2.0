...
At this handoff, nothing was broken. The next work was T-201 real schema and migrations (design-heavy, deserving a fresh session), T-208 Lance spike, and T-401 model registry. The textsignal functions were not yet wired into the capture path; that later wiring is recorded in `2026-09-07-capture-textsignal-wiring.md`.
